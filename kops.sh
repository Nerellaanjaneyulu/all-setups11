...
kops create cluster --name anjaneyulu.k8s.local --zones us-east-1a --control-plane-image ami-0f918f7e67a3323f0 --control-plane-count=1 --control-plane-size c7i-flex.large --image ami-0f918f7e67a3323f0 --node-count=2 --node-size c7i-flex.large
